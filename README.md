...
The example files (data_file, snp_map and gene_map) can be found in [here](https://github.com/xqwen/dap/tree/master/experiments/GEUVADIS). Note the input data file is using format 2 with pre-computed Bayes factors.